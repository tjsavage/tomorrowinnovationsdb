...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Update'
        db.create_table('dashboard_update', (
            ...
            ('startup', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dashboard.Startup'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('dashboard', ['Update'])


    def backwards(self, orm):
        
        # Deleting model 'Update'
        db.delete_table('dashboard_update')
