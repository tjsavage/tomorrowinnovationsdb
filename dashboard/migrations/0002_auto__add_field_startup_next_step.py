...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Startup.next_step'
        db.add_column('dashboard_startup', 'next_step', self.gf('django.db.models.fields.CharField')(default='H', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Startup.next_step'
        db.delete_column('dashboard_startup', 'next_step')
